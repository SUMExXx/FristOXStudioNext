...
function UniqueFeatures() {
  return (
    <div className='w-full flex items-center justify-center md:px-20 md:py-10 md:gap-20'>
        ...
        <div className='flex flex-col justify-center items-center w-full md:gap-8'>
          <div className='flex w-full md:h-[100px] rounded-[40px] items-center justify-center md:px-20 md:py-5 md:gap-20 bg-primary text-[60px]'>
            <WallpaperIcon fontSize='inherit' className='w-[60px] h-[60px] text-[60px] text-foreground2'/>
          ...
          <div className='flex w-full md:h-[100px] rounded-[40px] items-center justify-center md:px-20 md:py-5 md:gap-20 bg-primary text-[60px]'>
            <AnimationIcon fontSize='inherit' className='w-[60px] h-[60px] text-[60px] text-foreground2'/>
            <div className='w-full flex flex-col justify-center items-center md:gap-2'>
          ...
          <div className='flex w-full md:h-[100px] rounded-[40px] items-center justify-center md:px-20 md:py-5 md:gap-20 bg-primary text-[60px]'>
            <ViewInArIcon fontSize='inherit' className='w-[60px] h-[60px] text-[60px] text-foreground2'/>
            <div className='w-full flex flex-col justify-center items-center md:gap-2'>
          ...
          <div className='flex w-full md:h-[100px] rounded-[40px] items-center justify-center md:px-20 md:py-5 md:gap-20 bg-primary text-[60px]'>
            <DrawIcon fontSize='inherit' className='w-[60px] h-[60px] text-[60px] text-foreground2'/>
            <div className='w-full flex flex-col justify-center items-center md:gap-2'>
