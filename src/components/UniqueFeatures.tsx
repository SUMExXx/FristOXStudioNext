  ...
  return (
    <div className='w-full flex items-center justify-center md:px-20 md:py-10 md:gap-20'>
        ...
        <div className='flex flex-col justify-center items-center w-full md:gap-10'>
          <div className='flex w-full md:h-[120px] rounded-[40px] items-center justify-center md:px-20 md:py-5 md:gap-20 bg-primary text-[60px]'>
            <WallpaperIcon fontSize='inherit' className='w-[60px] h-[60px] text-[60px] text-foreground'/>
            <div className='w-full flex flex-col justify-center items-center md:gap-5'>
