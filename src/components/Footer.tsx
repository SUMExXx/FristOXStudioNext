  ...
  return (
    <div className='w-full flex justify-center items-start md:px-32 md:pt-10 md:pb-20 relative'>
        <div className='w-full flex flex-col justify-start items-start md:gap-10'>
          <Image src={'/icons/fristox-studio.png'} width={131} height={40} draggable={false} alt={"Frist'OX Studio"} className='brightness-0 dark:brightness-100 md:w-[131px] md:h-[40px] w-[235px] h-[30px]'></Image>
